...
#define HSE_BYPASS_INPUT_FREQUENCY   16000000 //WARNING!!!!
...
/* Settings by Tilen Majerle */
	...
	uint32_t SystemCoreClock = ((HSI_VALUE / 25) * 360) / 2;
#else
	/* External clock */
	uint32_t SystemCoreClock = ((HSE_VALUE / 25) * 360) / 2;
#endif
...
void SystemCoreClockUpdate(void)
{
  ...
  switch (tmp)
  {
    ...
    case 0x08:  /* PLL P used as system clock source */
       /* PLL_VCO = (HSE_VALUE or HSI_VALUE / 25) * 360
         SYSCLK = PLL_VCO / 2
         */    
...
/* Enable HSE if user wants it. Added by TM */
	...
	if (HSEStatus == (uint32_t)0x01) {
		...
		/* Configure the main PLL */
		RCC->PLLCFGR = 25 | (360 << 6) | (((2 >> 1) -1) << 16) |
		   (RCC_PLLCFGR_PLLSRC_HSE) | (7 << 24) | (PLL_R << 28);
#endif /* STM32F446xx */    
	...
	else /* Internal RC here */
	{
		...
		RCC->PLLCFGR = 25 | (360 << 6) | (((2 >> 1) -1) << 16) | (7 << 24); 
