...
regulatorParam_t regulatorParamDry;
regulatorParam_t regulatorParamSldr;
...
//    pidSLDR.param.Umin = pidPLL.term.Out-1;
    ...
    pidDRY.term.Fbk = *(regulatorParamDry.p_Fbk);
    pidDRY.term.Ref = *(regulatorParamDry.p_Ref);
    
    pidSLDR.term.Fbk =  *(regulatorParamSldr.p_Fbk);
    pidSLDR.term.Ref =  *(regulatorParamSldr.p_Ref);
...
{
    assert(params.p_Fbk == NULL);
    assert(params.p_Ref == NULL);
